      ...
      {requests.map((req, index) => (
        ...
        >
          <div className="break-words max-w-full">
            <p className="text-lg font-semibold">{req.user?.name || "Usuario desconocido"}</p>
          ...
          <div className="flex flex-col md:flex-row gap-2 w-full md:w-auto">
            <button
              ...
              disabled={!req.user}
              className="w-full md:w-auto bg-indigo-600 hover:bg-indigo-500 text-white font-semibold py-1 px-4 rounded-lg text-sm disabled:opacity-50"
            >
              Ver perfil
            </button>
          </div>
